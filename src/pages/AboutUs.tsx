  ...
  return (
    ...
    <div className="select-none min-h-screen w-full pt-16 flex flex-col">
      ...
      <div className="flex-grow grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8 justify-center mt-20 mb-20 font-bold font-inter mx-10">
        {[
          { name: 'Samuel Monsalves', imgSrc: '/src/assets/samuel.jpeg', github: 'https://github.com/SamuelMonsalvesMoreira' },
          { name: 'Clara Ricioni', imgSrc: '/src/assets/clara.jpeg', github: 'https://github.com/clararicioni' },
          { name: 'Ana Beatriz Ramos', imgSrc: '/src/assets/anab.jpeg', github: 'https://github.com/AnaBeatriz-R' },
          { name: 'Renato Alexandre', imgSrc: '/src/assets/renato.jpeg', github: 'https://github.com/RenatoAC2004' },
          { name: 'Frederick Rost', imgSrc: '/src/assets/renato.jpeg', github: 'https://github.com/rostfred' },
        ].map((person, index) => (
