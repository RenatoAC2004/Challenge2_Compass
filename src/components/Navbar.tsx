...
const Navbar = () => {
  ...
  return (
    <header className="w-full h-[5.5rem] px-6 py-4 flex justify-between sm:px-24 ">
      ...
      <div
        className={`block absolute top-0 bg-primaryAvacado h-full p-4 transition-all ease-in-out sm:w-1/2 w-3/4 md:hidden ${
          menuOpen ? "-left-0" : "-left-full"
        }`}
      >
        <div className="flex justify-center items-center border-b-2 border-primaryLunarGreen pb-4">
        ...
        <div className="flex flex-col text-center gap-y-2 py-4 border-b-2 border-primaryLunarGreen">
          <Link
            to="/"
            className="px-2 py-3 bg-white rounded-lg shadow-md transition-all hover:bg-primaryLunarGreen hover:text-white"
          >
            Home
          </Link>
          <Link
